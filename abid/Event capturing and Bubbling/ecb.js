...
// For stopPropagation() the above rules will be applied.
// ***just the fact is -> where ever the program fill the stopPropagation(),
// it will be executed upto this and then stopped.
